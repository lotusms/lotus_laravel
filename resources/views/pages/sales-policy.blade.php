...
@section('content')
  <main class="main-body py-4">
      <div class="uk-container uk-container-large uk-light">
        ...
        <hr/>
        <div class="q-pa-xl">
          <h3 class="green-text playball pt-4">Payment Policy</h3>

          <p>One-half of the initial website design and development fees are due upon project initiation. Upon project completion, the remaining balance is due in full within five business days. If the remaining balance is not paid in full by the given deadline the website will be set offline until payment is received.
          <br><br/>
          ...
          <h3 class="green-text playball pt-4">Web Maintenance Plan</h3>
          
          <p>Our maintenance plan covers ONLY current content in the site. Any additions falls in the realm of new design and development and other fees apply.
          <br><br>
          ...
          <br><br>
          The Web Maintenance Plan is not exclusive to our websites only. If you had a website done somewhere else and you wish to have it maintained by us, we will be glad to do so.</p>
          
          <h3 class="green-text playball pt-4">Billing</h3>
          
          <p>If a billing error is noticed, the client should immediately contact us. Refunds of over-payments will be made for up to a maximum of three months, so clients are urged to check billing statements regularly. Additionally, LOTUS Marketing Solutions reserves the right to bill clients for accidental under-charges for a maximum of up to three months. Refunds of more than three months will not be processed.
          <br><br>
          ...
          <br><br>
          Non-recurrent payments of $100+ can be made in check or credit card.</p>
          
          <h3 class="green-text playball pt-4">Project Timeliness</h3>
          
          <p>Every website varies in size, functionality, and content. Also, not every client is as efficient to submit all necessary content nor is it possible to guarantee that all necessary content will always be available right away. For these reasons, and others outside of our control (i.e. servers, hosting, etc.) we cannot guarantee a fixed date. Most of our websites take an average of 2 months before they are completed, yet we have done it in as little as 4 weeks. Please understand that most of it will depend on your ability to communicate with us.</p>
          
          <h3 class="green-text playball pt-4">Website Approval</h3>
          
          <p>Before your website enters the design phase, you will have one or two consults to discuss price, your needs, and your goals. At this time, we will present to you a prototype template based on information collected from you. You may or may not agree or approve to this template, as well as give us feedback regarding what you are looking for on your design.
          <br><br>
          ...
          <br><br>
          At this time, the site will be transferred to the live server and continue until it is completed.</p>
          ...
          <h3 class="green-text playball pt-4">Graphic Design</h3>
          
          <p>After gathering all necessary information, LOTUS Marketing Solutions will provide three different variations to the design to choose from or combine. Effective communication is crucial in the design phase.</p>
          
          <h3 class="green-text playball pt-4">Your Consent</h3>
          
          <p>By using our site, you consent to our web site sales policy.</p>
          
          <h3 class="green-text playball pt-4">Changes to our Sales Policies</h3>
          
          <p>If we decide to change our sale policy, we will post those changes on this page. This policy was last modified on 01/10/2012</p>
